...
function About(){
    ...
    return(
        <section className="min-h-[100vh] py-20 flex justify-center items-center px-[5%] bg-secondary border-t border-[#eaeaea] border-solid max-w-[100vw] overflow-hidden dark:bg-darkprimary" id='skills'>
