...
import { FaEye, FaArrowRight, FaGithub } from "react-icons/fa";
...
function Products({ showAll = false }: { showAll?: boolean }){
    ...
    return(
        <section className="relative py-20 flex justify-center items-center px-[5%] border-t border-[#eaeaea] border-solid dark:border-[#E5E7EB6E] overflow-hidden" id="projects">
            {/* Animated background */}
                ...
                <div className="relative z-10 mt-6">
                    {
                        displayProjects.map((project)=>(
                            <div className="flex justify-center" key={project.title}>
                                <div className="block hover:scale-[1.01] 750:flex bg-[white]/80 backdrop-blur-sm rounded-xl ring-1 ring-[rgb(51,65,85)]/[0.1] mt-3 shadow-lg relative overflow-hidden max-w-none 1100:max-w-[80%] dark:bg-darksecondary/80 dark:text-[white] dark:ring-[rgb(255,255,255)]/[0.3] transition-all duration-300">
                                    ...
                                    <div className="px-5 500:px-10 py-5 750:flex-[0%] grid">
                                        ...
                                        <div className="mt-auto pt-5 flex gap-x-3">
                                            {
                    ...
                    <div className="relative z-10 flex justify-center mt-12">
                        <Link href="/products">
                            <Button
                                ...
                                title="View All Projects" label="View All Products"/>
                        </Link>
                    </div>
                )} */}
            </div>
