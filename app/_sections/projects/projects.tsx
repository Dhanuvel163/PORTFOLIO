...
function Projects(){
    ...
    return(
        <section className="min-h-[100vh] py-20 flex justify-center items-center px-[5%] bg-[white] border-t border-[#eaeaea] border-solid">
                                            ...
                                            <div className="mt-auto pt-5">
                                                {
                                                    project.actions.map((action)=>(
                                                        <Link href={action.link} target="_blank" key={action.label}>
                                                            <Button label={action.label} icon={<SiCodereview/>} title={action.action}/>
                                                        </Link>
                                                    ))
                                                }
                                            </div>
