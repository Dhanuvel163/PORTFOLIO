...
function Header(){
    ...
    return(
        <header className="fixed flex justify-between top-0 z-40 w-full border-[#e5e7eb] dark:border-[#E5E7EB6E] border-solid border-b backdrop-blur px-1 350:px-3 750:px-10">
