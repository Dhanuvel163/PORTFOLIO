function Iconcard({
    ...
    return(
        <div className="relative bg-[white]/90 backdrop-blur-md dark:bg-darksecondary/90 dark:text-[white] dark:ring-[rgb(255,255,255)]/[0.3] rounded-2xl p-5 py-6 shadow-lg ring-1 ring-[rgb(51,65,85)]/[0.1] transition-all duration-500 hover:shadow-2xl hover:scale-[1.08] group cursor-pointer overflow-hidden">
