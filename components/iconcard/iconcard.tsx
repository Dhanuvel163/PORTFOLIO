function Iconcard({
    ...
    return(
        <div className="bg-[white]/80 backdrop-blur-sm dark:bg-darksecondary/80 dark:text-[white] dark:ring-[rgb(255,255,255)]/[0.3] rounded-xl p-4 py-5 mt-3 shadow-lg ring-1 ring-[rgb(51,65,85)]/[0.1] transition-all duration-300 hover:shadow-xl hover:scale-[1.05] group cursor-pointer">
