...
function Skillscard({
    ...
    return(
        <div className='group/card bg-[white]/90 backdrop-blur-md dark:bg-darksecondary/90 dark:text-[white] rounded-2xl ring-1 ring-[rgb(51,65,85)]/[0.1] shadow-lg relative hover:z-10 dark:ring-[rgb(255,255,255)]/[0.3] transition-all duration-500 hover:shadow-2xl hover:scale-[1.03]'>
            ...
            <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl from-primary/20 to-transparent dark:from-primary/30 rounded-bl-[100%] opacity-0 group-hover/card:opacity-100 transition-opacity duration-500 overflow-hidden rounded-tr-2xl"></div>
            <div className="absolute bottom-0 left-0 w-20 h-20 bg-gradient-to-tr from-secondary/15 to-transparent dark:from-darkprimary/25 opacity-0 group-hover/card:opacity-100 transition-opacity duration-500 overflow-hidden rounded-tr-2xl"></div>

            <h3 className='font-bold text-xl text-[black] px-4 py-3 border-b border-[#e5e7eb] dark:border-[rgb(255,255,255)]/[0.3] border-solid dark:text-[white] bg-gradient-to-r from-primary/10 via-primary/5 to-transparent relative overflow-hidden rounded-t-2xl'>
