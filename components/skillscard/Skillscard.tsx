...
function Skillscard({
    ...
    return(
        <div className='group/card bg-[white]/90 backdrop-blur-md dark:bg-darksecondary/90 dark:text-[white] rounded-2xl ring-1 ring-[rgb(51,65,85)]/[0.1] shadow-lg relative hover:z-10 dark:ring-[rgb(255,255,255)]/[0.3] transition-all duration-500 hover:shadow-2xl hover:scale-[1.03] overflow-hidden'>
